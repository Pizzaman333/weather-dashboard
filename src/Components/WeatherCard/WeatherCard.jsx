...
const WeatherCard = ({ data, onRefresh, onDelete, onForecast, onDetails }) => {
  ...
  return (
    <div className={styles["weather-card"]}>
      <div className={styles["weather-card__header"]}>
        ...
        <span className={styles["weather-card__country"]}>{data.sys.country}</span>
      </div>
      ...
      <div className={styles["weather-card__footer"]}>
        <div className={styles["weather-card__actions-left"]}>
          <button onClick={handleRefresh} className={styles["weather-card__icon-btn"]}>
            <SpinnerSvg 
              className={`${styles["weather-card__icon"]} ${styles["weather-card__icon--refresh"]} ${isRefreshing ? styles["weather-card__icon--spin"] : ""}`} 
            />
          </button>
          <button className={styles["weather-card__icon-btn"]}>
            <HeartSvg className={`${styles["weather-card__icon"]} ${styles["weather-card__icon--heart"]}`} />
          </button>
        </div>
        ...
        <div className={styles["weather-card__actions-right"]}>
          <button onClick={onDelete} className={styles["weather-card__icon-btn"]}>
            <BinSvg className={`${styles["weather-card__icon"]} ${styles["weather-card__icon--bin"]}`} />
          </button>
        </div>
      </div>
    </div>

...
const WeatherDashboard = ({ cities, onRemoveCity }) => {
  ...
  const [activeMode, setActiveMode] = useState(null); // 'hourly' | 'details' | null
  ...
  if (loading)
    return <div className={styles["weather-dashboard__loading"]}>Loading weather...</div>;
  ...
  return (
    <div className={styles["weather-dashboard"]}>
      <Container>
        ...
        {activeMode && (
          <div ref={detailsSectionRef} className={styles["weather-dashboard__details-section"]}>
            
            <div className={styles["weather-dashboard__separator"]}></div>
            
            <h2 className={styles["weather-dashboard__section-title"]}>
              {activeMode === 'hourly' ? 'Hourly Forecast' : 'Weather Details'} for <span className={styles["weather-dashboard__highlight"]}>{activeCityName}</span>
            </h2>
            ...
            <div className={styles["weather-dashboard__content-wrapper"]}>
              ...
              {activeMode === "hourly" && (
                isForecastLoading 
                  ? <div className={styles["weather-dashboard__sub-loading"]}>Loading Forecast...</div>
